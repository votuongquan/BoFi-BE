...
from app.modules.products.schemas.product_response import ProductResponse, SearchProductResponse
...
route = APIRouter(prefix='/products', tags=['Products'], dependencies=[Depends(verify_token)])
...
async def search_products(
    ...
    sort_by: str | None = Query(None, description='Field to sort by (e.g., price, name)'),
